    ...
    <div className="h-12 z-[100] bg-navBar flex justify-between items-center absolute bottom-0  w-full">
      ...
      <div className="flex items-center justify-end flex-1 px-4">
        <Tooltip TransitionComponent={Zoom} title="S.E.N.K.U. Coming Soon" arrow>
          ...
          >
            <svg width="30" height="30" viewBox="0 0 506 358" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3 179C3 81.7979 81.7979 3 179 3H327C424.202 3 503 81.7979 503 179V214C503 291.872 439.872 355 362 355H144C66.1279 355 3 291.872 3 214V179Z" fill="url(#paint0_linear_101_159)" stroke="#095679" stroke-width="6"/>
<path d="M3 179C3 81.7979 81.7979 3 179 3H327C424.202 3 503 81.7979 503 179V194C503 271.872 439.872 335 362 335H144C66.1279 335 3 271.872 3 194V179Z" fill="url(#paint1_linear_101_159)" stroke="#095679" stroke-width="3"/>
...
<defs>
<filter id="filter0_f_101_159" x="161.289" y="257" width="175.457" height="71.0039" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
